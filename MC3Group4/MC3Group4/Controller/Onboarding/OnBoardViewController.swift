...
class OnBoardViewController: UIViewController, PaperOnboardingDelegate, PaperOnboardingDataSource {
    ...
    func ifOnboardingDone(){
        ...
        if (onboardDone == true){
            ...
            DispatchQueue.main.async {
                self.performSegue(withIdentifier: "onBoardingToDiscover", sender: self)
            }
    ...
    func onboardingItem(at index: Int) -> OnboardingItemInfo {
        ...
        return [
            OnboardingItemInfo(informationImage: #imageLiteral(resourceName: "Walk-2"),
            ...
            OnboardingItemInfo(informationImage: #imageLiteral(resourceName: "Sketch-2"),
            ...
            OnboardingItemInfo(informationImage: #imageLiteral(resourceName: "Give-2"),
